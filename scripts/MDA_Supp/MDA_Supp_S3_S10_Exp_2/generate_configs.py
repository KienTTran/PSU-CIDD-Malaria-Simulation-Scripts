    ...
    for z in params['z']:
        for k in params['kappa']:
            for beta in params['beta']:
                ...
                new_data['immune_system_information']['immune_effect_on_progression_to_clinical'] = z
                new_data['immune_system_information']['factor_effect_age_mature_immunity'] = k
                
                output_filename = 'generated_inputs/sim_prmc_pop_%s_kappa_%.2f_z_%.2f_beta_%.3f.yml'%(str(params['population'][-1]),k,z,beta)
