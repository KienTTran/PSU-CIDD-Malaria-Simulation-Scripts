...
data_plot.to_csv(local_path + str(exp_number) + '_EIR_PfPR_tm' + str(tm) + '_k' + str(kappa) + '_z' + str(z) + ".csv",index=False)  


data_plot = pd.read_csv(local_path + str(exp_number) + '_EIR_PfPR_tm' + str(tm) + '_k' + str(kappa) + '_z' + str(z) + ".csv") 
...
plot.figure.savefig(local_path + str(exp_number) + '_EIR_PfPR_Log_tm' + str(tm) + '_k' + str(kappa) + '_z' + str(z) + '.png', dpi=300)
...
plot.figure.savefig(local_path + str(exp_number) + '_EIR_PfPR_Linear_tm' + str(tm) + '_k' + str(kappa) + '_z' + str(z) + '.png', dpi=300)