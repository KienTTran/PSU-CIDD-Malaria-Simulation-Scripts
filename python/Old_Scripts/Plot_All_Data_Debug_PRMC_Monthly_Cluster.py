...
def plot_one_header_CI(header, data, col_index, row_index, confident_interval):
    ...
    axis = axes[row_index,col_index] if rep_cols_observe > 1 else axes[row_index]
...
fig.legend(loc='lower center', labels=[str(i) for i in rep_locations[0]], ncol = len(rep_tags))