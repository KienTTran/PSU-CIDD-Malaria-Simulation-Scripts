...
# local_path = "D:/plot/new/1M/4-Genotypes-2/PRMC"
# local_path = "D:/plot/new/1M/4-Genotypes-2/Parasite"
plot_delay = 2
...
for rep_file in simulations:
    ...
    for data in rep_data_observe:        
        ...
        # data["0:[KY] - [K][Y]"] = ( data["0:KNY--C1x.1"] + data["0:KNY--C1X.1"]
        #                           + data["0:KNY--C2x.1"] + data["0:KNY--C2X.1"]                                
        #                           ) - (data["0:Allele K"] * data["0:Allele Y"])
